...
const createCompany = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const createdUser = yield user_model_1.default.create(Object.assign(Object.assign({}, userData), { role: auth_interface_1.userRoles.OWNER, companyId: createdCompany._id }));
